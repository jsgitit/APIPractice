...
public class EmployeeAddressControllerTests : ControllerTestsBase
{
    ...
    public async Task CanCreateOneEmployeeAddress()
    {
        ...
        var createdEmployeeAddress = await _httpClientHelper
            .PostAsync<EmployeeAddressCreateDto, EmployeeAddressDto>($"{_baseUrl}", newEmployeeAddress);
    ...
    public async Task CanGetAllEmployeeAddressesForOneEmployee()
    {
        ...
        var employeeUnknownAddress = await _httpClientHelper
            .PostAsync<EmployeeAddressCreateDto, EmployeeAddressDto>($"{_baseUrl}", newUnknownAddress);
        var employeeMailingAddress = await _httpClientHelper
            .PostAsync<EmployeeAddressCreateDto, EmployeeAddressDto>($"{_baseUrl}", newMailingAddress);
        var employeeResidentialAddress = await _httpClientHelper
            .PostAsync<EmployeeAddressCreateDto, EmployeeAddressDto>($"{_baseUrl}", newResidentialAddress);
    ...
    public async Task CanGetSingleEmployeeAddressByType()
    {
        // Arrange
        var employeeId = 6;
        var addressTypeId = (int)AddressType.Work;
        ...
        Assert.Equal(addressTypeId, (int)employeeAddress.AddressTypeId);
    ...
    public async Task CanUpdateSingleEmployeeAddress()
    {
        ...
        var updatedEmployee = await _httpClientHelper
            .PutAsync<EmployeeAddressUpdateDto, EmployeeAddressDto>($"{_baseUrl}", newEmployeeAddress);
    ...
    public async Task CannotAddAddressForNonExistentEmployee()
    {
        ...
        var response = await _httpClientHelper
            .PutAsync<EmployeeAddressCreateDto, HttpResponseMessage>($"{_baseUrl}", newUnknownAddress);
