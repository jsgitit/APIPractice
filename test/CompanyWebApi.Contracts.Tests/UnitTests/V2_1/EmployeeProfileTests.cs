...
public class EmployeeProfileTests
{
    ...
    public void EmployeeToEmployeeDto_ShouldMapCorrectly()
    {
        ...
        Assert.Equal("123 Work St", employeeDto.Address);
    ...
    public void EmployeesToEmployeeDtos_ShouldMapCorrectly()
    {
        ...
        Assert.Equal("123 Work St", firstEmployeeDto.Address);
        ...
        Assert.Equal(string.Empty, secondEmployeeDto.Address); // No address provided
